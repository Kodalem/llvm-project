...
// WIN64: define dso_local void @ParamPassing(ptr align 8 dead_on_return %{{.+}}, i64 %{{.+}})
// LIN32: define{{.*}} void @ParamPassing(ptr align 4 dead_on_return %{{.+}}, i64 %{{.+}})
// WIN32: define dso_local void @ParamPassing(ptr align 8 dead_on_return %{{.+}}, i64 %{{.+}})
...
// RISCV32: define{{.*}} void @ParamPassing(ptr align 8 dead_on_return %{{.+}}, i64 signext %{{.+}})
// WASM: define{{.*}} void @ParamPassing(i128 %{{.+}}, i64 %{{.+}})
// SYSTEMZ: define{{.*}} void @ParamPassing(ptr align 8 dead_on_return %{{.+}}, i64 %{{.+}})
...
// LA32: define{{.*}} void @ParamPassing(ptr align 16 dead_on_return %{{.+}}, i64 %{{.+}})

void ParamPassing2(_BitInt(127) b, _BitInt(63) c) {}
// LIN64: define{{.*}} void @ParamPassing2(i64 %{{.+}}, i64 %{{.+}}, i64 %{{.+}})
// WIN64: define dso_local void @ParamPassing2(ptr align 8 dead_on_return %{{.+}}, i63 %{{.+}})
// LIN32: define{{.*}} void @ParamPassing2(ptr align 4 dead_on_return %{{.+}}, i63 %{{.+}})
// WIN32: define dso_local void @ParamPassing2(ptr align 8 dead_on_return %{{.+}}, i63 %{{.+}})
...
// RISCV32: define{{.*}} void @ParamPassing2(ptr align 8 dead_on_return %{{.+}}, i63 signext %{{.+}})
// WASM: define{{.*}} void @ParamPassing2(i127 %{{.+}}, i63 %{{.+}})
// SYSTEMZ: define{{.*}} void @ParamPassing2(ptr align 8  dead_on_return %{{.+}}, i63 signext %{{.+}})
...
// LA32: define{{.*}} void @ParamPassing2(ptr align 16 dead_on_return %{{.+}}, i63 %{{.+}})
...
// WIN64: define dso_local void @ParamPassing4(ptr align 8 dead_on_return %{{.+}})
// LIN32: define{{.*}} void @ParamPassing4(ptr align 4 dead_on_return %{{.+}})
// WIN32: define dso_local void @ParamPassing4(ptr align 8 dead_on_return %{{.+}})
// AARCH64: define{{.*}} void @ParamPassing4(ptr align 16 dead_on_return %{{.+}})
...
// LA64: define{{.*}} void @ParamPassing4(ptr align 16 dead_on_return %{{.+}})
// LA32: define{{.*}} void @ParamPassing4(ptr align 16 dead_on_return %{{.+}})
#endif
